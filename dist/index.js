...
var HeaderComponent = (function () {
    ...
    HeaderComponent.propDecorators = {
        "overrideRouter": [{ type: Input, args: ['overrideRouter',] },],
        "tarjetasContent": [{ type: Input, args: ['tarjetasContent',] },],
    };
...
var GaDirective = (function () {
    ...
    GaDirective.propDecorators = {
        "appGa": [{ type: Input, args: ['appGa',] },],
        "appGaCategory": [{ type: Input, args: ['appGaCategory',] },],
        "appGaAction": [{ type: Input, args: ['appGaAction',] },],
        "appGaLabel": [{ type: Input, args: ['appGaLabel',] },],
...
var ScrolltoDirective = (function () {
    ...
    ScrolltoDirective.propDecorators = {
        "appScrollto": [{ type: Input, args: ['appScrollto',] },],
        "notMobile": [{ type: Input, args: ['notMobile',] },],
        "factor": [{ type: Input, args: ['factor',] },],
        "onClick": [{ type: HostListener, args: ['click', ['$event'],] },],
    };
...
var SwiperDirective = (function () {
    ...
    SwiperDirective.propDecorators = {
        "qSlidePerView": [{ type: Input, args: ['qSlidePerView',] },],
        "nextEl": [{ type: Input, args: ['nextEl',] },],
        "prevEl": [{ type: Input, args: ['prevEl',] },],
        "element": [{ type: Input, args: ['element',] },],
        "paginationEl": [{ type: Input, args: ['paginationEl',] },],
        "checkMobile": [{ type: Input, args: ['checkMobile',] },],
        "checkResize": [{ type: Input, args: ['checkResize',] },],
        "onResize": [{ type: HostListener, args: ['window:resize', ['$event'],] },],
    };
...
var HeadroomDirective = (function () {
    function HeadroomDirective(el, document) {
        ...
        this.updateAditionalContentTarjetas = new EventEmitter();
    ...
    HeadroomDirective.propDecorators = {
        "updateAditionalContentTarjetas": [{ type: Output },],
    };
...
var MarkedPipe = (function () {
     ...
     */
    function (value, args) {
        if (isUndefined(value) === true || value === '')
            return '';
        return marked(value);
    };
