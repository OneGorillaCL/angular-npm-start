(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/common'), require('@angular/router'), require('@angular/animations'), require('contentful'), require('util'), require('@angular/platform-browser')) :
	typeof define === 'function' && define.amd ? define(['exports', '@angular/core', '@angular/common', '@angular/router', '@angular/animations', 'contentful', 'util', '@angular/platform-browser'], factory) :
	(factory((global['fif-uikit-angular-base'] = {}),global.core,global.common,global.router,global.animations,global.contentful,global.util,global.platformBrowser));
}(this, (function (exports,core,common,router,animations,contentful,util,platformBrowser) { 'use strict';
 ...
 * @suppress {checkTypes} checked by tsc
 */
var fadeInEffect = animations.trigger('fadeInEffect', [
    animations.transition(':enter', [
        animations.style({ transform: '', opacity: 0 }),
        animations.animate('500ms', animations.style({ transform: '', 'opacity': 1 }))
    ]),
    animations.transition(':leave', [
        animations.style({ transform: '', 'opacity': 1 }),
        animations.animate('500ms', animations.style({ transform: '', 'opacity': 0 }))
    ])
]);
